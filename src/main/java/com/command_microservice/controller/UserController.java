...
@Controller
@RequestMapping(value = "command/api/user", produces = MediaType.APPLICATION_JSON_VALUE)
...
//    @PreAuthorize("hasAuthority('UPDATE')")
    public ResponseEntity<Object> updateUser(@RequestBody User user) throws GenericException {
